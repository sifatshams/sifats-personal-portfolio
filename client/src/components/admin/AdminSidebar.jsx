    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="hidden lg:flex absolute right-[-20px] cursor-pointer top-7 w-10 h-10 rounded-full bg-gradient-to-br from-[#646cff] to-[#4e5dff] items-center justify-center border border-slate-700 shadow-xl shadow-[#646cff]/30 hover:scale-110 transition-all duration-300 z-[60]"
        >
            ...
            <div className="space-y-2">
              {menus.map((menu) => (
                ...
                >
                  ...
                  {collapsed && (
                    <div className="absolute left-20 z-50 pointer-events-none rounded-xl border border-slate-700 bg-slate-800 px-3 py-2 text-sm whitespace-nowrap opacity-0 duration-300 group-hover:left-24 group-hover:opacity-100">
                      {menu.title}
                    </div>
                  )}
                </NavLink>
